...
def rand_bamboo(n1, n2):
    ...
    for i in range(b):
        ...
        main_surf.blit(draw_bamboo((width, height)), (x, y))

def draw_panda(size, rotation):
    ...
    pg.draw.polygon(
        back_leg,
        colors['black'],
        [(0, 20), (0, 30), (30, 65), (100, 90),(150, 90), (160, 0), (0, 20)]
    )
    ...
    pg.draw.polygon(
        front_left_leg,
        colors['black'],
        [(154, 0), (100, 0), (100, 100), (60, 220), (154, 200)]
    )
    ...
    rev = pg.transform.flip(body, True, False)
...
def rand_panda(n1, n2):
    p = random.randint(n1, n2)
    for i in range(p):
        x = random.randint(100, 1100)
        y = random.randint(200, 600)
        width = random.randint(100, 350)
        height = int( width * 1.3 )
        rotation = random.randint(0, 1)
        main_surf.blit(draw_panda((width, height), rotation), (x, y))
